...
hydro_sim = loadmat("sims/hyd_sim.mat")

file_y = "sols/hyd_sol_y.p"
file_t = "sols/hyd_sol_t.p"
...
grid_x = np.linspace(0, 7, 50)
grid_z = np.linspace(-14, 7, 50)
...
file_f3 = 'output/f3_hyd_8.p'
file_ps = 'output/ps_hyd_8.p'
...
file_flux = 'output/flux_hyd.p'
file_wavs = 'output/wavs_hyd.p'

with open(file_flux, "wb") as f:   
    pickle.dump(flux_frac, f)
with open(file_wavs, "wb") as f:   
    pickle.dump(ws, f)
